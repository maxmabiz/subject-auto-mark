  ...
  extras.push(
    {
      transaction: base({
        id: "tx-081",
        transactionNo: "PO-20260820-081",
        platform: "Payoneer",
        account: "Payoneer-HQY",
        transactionTime: at(20, 9, 10),
        amount: 2680,
        direction: "in",
        transactionDescription: "weekly ADS_PAYOUT from agency",
      }),
      manual: null,
      feishu: null,
      logs: [],
    },
    {
      transaction: base({
        id: "tx-082",
        transactionNo: "PO-20260820-082",
        platform: "Payoneer",
        account: "Payoneer-HQY",
        transactionTime: at(20, 10, 20),
        amount: 1540,
        direction: "in",
        transactionDescription: "media rebate transfer",
        note: "8月广告结算",
      }),
      manual: null,
      feishu: null,
    ...
    },
    {
      transaction: base({
        id: "tx-083",
        transactionNo: "AW-20260820-083",
        platform: "Airwallex",
        account: "Airwallex-HQY",
        transactionTime: at(20, 11, 5),
        amount: 9800,
        direction: "in",
        transactionDescription: "store collection batch",
    ...
    },
    {
      transaction: base({
        id: "tx-084",
        transactionNo: "PG-20260820-084",
        platform: "PingPong",
        account: "PingPong-BESTTECH-B2C",
        transactionTime: at(20, 13, 40),
        amount: 6200,
        direction: "out",
        transactionDescription: "vendor WITHDRAW to bank",
      }),
      manual: null,
      feishu: null,
      logs: [],
    },
    {
      transaction: base({
        id: "tx-085",
        transactionNo: "HSBC-20260820-085",
        platform: "HSBC",
        account: "HSBC-HK-001",
        transactionTime: at(20, 14, 15),
        amount: 88000,
        currency: "HKD",
        direction: "out",
        transactionDescription: "office rent August",
        note: "8月工资发放",
      }),
      manual: null,
      feishu: null,
    ...
    },
    {
      transaction: base({
        id: "tx-086",
        transactionNo: "WF-20260820-086",
        platform: "Worldfirst",
        account: "Worldfirst-besttech",
        transactionTime: at(20, 16, 30),
        amount: 11200,
        direction: "in",
        transactionDescription: "marketplace collection",
