...
const groupClass = "flex w-full items-center gap-2 whitespace-nowrap rounded-md px-2.5 py-1.5 text-left text-[14px] font-medium leading-6 text-white/90 hover:bg-white/10";
const itemClass = "ml-3 flex items-center gap-2 whitespace-nowrap rounded-md px-2.5 py-1.5 text-left text-[14px] font-medium leading-6 text-white/80 hover:bg-white/10";
...
export function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f5f7fb]">
      <aside className="sticky top-0 flex h-screen w-[200px] shrink-0 flex-col overflow-x-hidden bg-[#16356b] text-white">
        <div className="border-b border-white/10 px-3 py-4">
          <div className="whitespace-nowrap text-[14px] font-semibold leading-6 tracking-wide">{PRODUCT_NAME}</div>
          <div className="mt-1 whitespace-nowrap text-[14px] leading-5 text-white/70">资金后台 · 科目标记</div>
        </div>
        ...
        <div className="border-t border-white/10 px-3 py-3 text-[14px] leading-5 text-white/50">
