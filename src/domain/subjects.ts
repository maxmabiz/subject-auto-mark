import type { Rule, SubjectPath } from "./types";
import { EXTRA_SUBJECTS } from "./constants";
import { subjectKey } from "./matching/normalize";

export function buildSubjectDictionary(rules: Rule[]): SubjectPath[] {
